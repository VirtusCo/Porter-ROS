 ...
 *
 * Polynomial: 0x1021 (CRC-CCITT / CRC-16/XMODEM variant with init 0xFFFF)
 * Initial value: 0xFFFF
 * No final XOR
 *
 * Uses a 256-entry lookup table (512 bytes ROM) for fast computation.
...
/**
 * Pre-computed CRC16-CCITT lookup table.
 * Generated with polynomial 0x1021.
 * Each entry: crc16_table[i] = CRC of single byte i with init=0.
 */
